...
namespace SpigotPlusPlus {
    ...
    public:
        JavaStaticMethod(jclass const& clazz, std::string const& className, jmethodID const& method, JavaType const& returnType, std::vector<JavaType> const& argumentTypes, std::string const& name);
